...
export const bakingDessertsRecipes: Recipe[] = [
  ...
  },
  {
    ...
    shortDescription: "Die süße und reichhaltige Spezialität aus Lüttich. Ein fester Hefeteig, angereichert mit Butter und dem charakteristischen Perlzucker, der beim Backen karamellisiert und für eine unwiderstehlich knusprige Außenseite und einen weichen Kern sorgt.",
    prepTime: "20 Min.",
    cookTime: "20 Min.",
