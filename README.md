...
- **M5:** **abgeschlossen** — Vitest **374** Tests in **90** Dateien; Coverage v8 ca. **78 %** stmts / **79 %** lines / **72,5 %** funcs / **63 %** branches (PRD ≥70/≥70/≥70/≥60). Thresholds in `apps/web/vitest.config.ts`: **77/79/72/62**.
