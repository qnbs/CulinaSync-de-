...
| ID | Severity | Issue-Titel | Impact | Effort | Why now? | Abhängigkeiten |
|----|----------|-------------|--------|--------|----------|----------------|
| R-001 | High | `feat(sync): Zod-validate device sync QR payload` | Security / Datenintegrität | S | QR-Sync ist live ohne Schema-Gate | — |
