...
- **Coverage (M5 ✅, Juni 2026):** ca. **78 %** stmts / **79 %** lines / **72,5 %** funcs / **63 %** branches (v8); Thresholds **77/79/72/62** in `apps/web/vitest.config.ts`. **364** Tests / **86** Dateien. **CI:** `validate.yml` (lint → type-check → test:coverage → build → audit); Playwright in `e2e-smoke.yml`; Artefakt **coverage-lcov** (`apps/web/coverage`). Status: `docs/STATUS-2026-06-02.md`.
